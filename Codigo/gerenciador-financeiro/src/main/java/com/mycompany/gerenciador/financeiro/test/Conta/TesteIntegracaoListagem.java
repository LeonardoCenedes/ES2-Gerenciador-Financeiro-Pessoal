...
public class TesteIntegracaoListagem {
    ...
    private static void prepararDadosTeste() {
        ...
        try {
            ...
            controller.cadastrarConta("Conta Teste 1", "Conta Corrente", 1000.0, "BRL");
            controller.cadastrarConta("Conta Teste 2", "Poupança", 2000.0, "BRL");
            controller.cadastrarConta("Conta Teste 3", "Cartão de Crédito", 0.0, "BRL");
