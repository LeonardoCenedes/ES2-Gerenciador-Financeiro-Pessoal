...
public class TesteIntegracaoExclusao {
    ...
    private static void prepararDadosTeste() {
        ...
        try {
            ...
            controller.cadastrarConta("Conta Excluir 1", "Conta Corrente", 1000.0, "BRL");
            controller.cadastrarConta("Conta Excluir 2", "Poupança", 2000.0, "BRL");
            controller.cadastrarConta("Conta Excluir 3", "Cartão de Crédito", 0.0, "BRL");
